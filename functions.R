...
probability_winning_custom_data <- function(data_set, spread_data_set){

## Set up for computing the distributions of spreads in regards to jon ossoff

fit <- MASS:: fitdistr(spread_data_set$value, "normal")
  
n <- 100000

empty_vec <- rep((data_set %>%
