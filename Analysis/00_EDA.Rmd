...
Even though I will be modeling the Ossoff vs Perdue race I thought it might be insightful to see where the other Georgia Senate race stands. The top two candidates are basically tied. 
...
Polling quality will be important when trying to make predictions. Below I made a quick graph showing the fivethirtyeight ratings for every poll. They take many things into consideration when rating the polls such as sample size and partisan lean of a pollster. I will use this information more in my analysis file `05_weighted sampling`.
...
Next up, I wanted to see where the polls currently stand for the Perdue vs Ossoff race, so below I plotted the current polling averages.
...
Lastly, I wanted to pull in some historical data to see how past candidates performed in Georgia Senate elections. Mostly curious about how well Republicans did compared to Democrats.
